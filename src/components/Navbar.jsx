...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between p-5 bg-black text-gray-400 sticky top-0 z-50">
      ...
      {/* Mobile Sliding Menu */}
      <div className={`fixed top-0 right-0 h-full w-64 bg-black text-center p-4 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
